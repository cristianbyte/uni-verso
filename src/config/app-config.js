...
export const DEEZER_PROXY_URL =
  import.meta.env.VITE_DEEZER_PROXY_URL ?? 'https://proxi-api.vercel.app/api/proxy';

export const LYRICS_API_BASE_URL =
  import.meta.env.VITE_LYRICS_API_BASE_URL ?? 'https://api.lyrics.ovh/v1';

export const DEEZER_COVER_BASE_URL = 'https://e-cdns-images.dzcdn.net/images/cover';

export const DEEZER_WIDGET_BASE_URL = 'https://widget.deezer.com/widget/light/track';
